...
import { Calendar, Clock, ChevronRight, TrendingUp, Heart, Star, ArrowLeft, Activity } from 'lucide-react';
          ...
          {sessions.map((session, i) => {
            ...
            return (
              <motion.button
                ...
                className="w-full text-left bg-surface-container p-5 rounded-2xl border border-outline-variant hover:border-primary/40 transition-all group"
              >
                <div className="flex items-center justify-between">
                  ...
                  <ChevronRight className="w-5 h-5 text-on-surface-variant group-hover:text-primary transition-colors flex-shrink-0" />
                </div>
              </motion.button>
            );
          })}
